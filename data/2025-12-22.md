...
### [10] [Quantum geometric contribution to the diffusion constant](https://arxiv.org/abs/2512.16986)
*A. A. Burkov*
...
### [11] [Single-$q$ Cycloid and Double-$q$ Vortex Lattices in Layered Magnetic Semimetal EuAg$_4$Sb$_2$](https://arxiv.org/abs/2512.16990)
...
### [12] [Shot noise signatures identifying non-Abelian properties of Jackiw-Rebbi zero modes](https://arxiv.org/abs/2512.17192)
...
### [13] [Kibble-Zurek mechanism in a polariton supersolid](https://arxiv.org/abs/2512.17362)
...
### [14] [Chiral topological superconductivity in twisted bilayer and double bilayer graphene](https://arxiv.org/abs/2512.17380)
...
### [15] [Theory of electric reactance emerging from spin Hall effect](https://arxiv.org/abs/2512.17420)
...
### [16] [Direct demonstration of time-reversal-symmetry-breaking spin injection from a compensated magnet](https://arxiv.org/abs/2512.17427)
...
### [17] [Quantum geometry, localization, and topological bounds of spin fluctuations](https://arxiv.org/abs/2512.17454)
...
### [18] [Synergy and Competition of Dual Chirality in the Chirality-Induced Spin Selectivity of Supramolecular Helices](https://arxiv.org/abs/2512.17617)
...
### [19] [Picosecond localization dynamics following ultrafast nanoscale magnetic switching](https://arxiv.org/abs/2512.17643)
...
### [20] [Higher-Order Topological Systems and Their Sub-Symmetry-Protected Topology](https://arxiv.org/abs/2512.17694)
...
### [21] [MOF-derived Fe-doped $δ$-MnO$_2$ nanoflowers as oxidase mimics: Chromogenic sensing of Hg$^{2+}$ and hydroquinone in aqueous media](https://arxiv.org/abs/2512.17731)
...
### [22] [Effective Mass in Dissipative Coupled Polaritons](https://arxiv.org/abs/2512.17833)
...
### [23] [Stability of (Active) Bilayer Skyrmions in Synthetic Antiferromagnets](https://arxiv.org/abs/2512.17862)
...
### [24] [Switchable Magnonic Crystals Based on Spin Crossover/CrSBr Heterostructures](https://arxiv.org/abs/2512.17003)
...
### [25] [Accurate atomic correlation and total energies for correlation consistent effective core potentials II: Rb-Xe elements](https://arxiv.org/abs/2512.17063)
...
### [26] [Tunable Electronic Transport in Pd$_3$O$_2$Cl$_2$ Kagome Bilayers: Interplay of Stacking Configuration and Strain](https://arxiv.org/abs/2512.17069)
...
### [27] [A Three-Dimensional Dodecaphenylyne-Derived Carbon Allotrope with Anisotropic and Auxetic-Like Mechanical Behavior](https://arxiv.org/abs/2512.17105)
...
### [28] [Engineering a Correlated Narrow-Gap Semiconductor: Effects of Ga Substitution in EuZn$_2$P$_2$](https://arxiv.org/abs/2512.17123)
...
### [29] [Anomalous Nernst effect in amorphous Tb-Fe-Co thin films](https://arxiv.org/abs/2512.17223)
...
### [30] [Yb 4f-Ta 5d Hybridization and Valence Evolution in Tetragonal Tungsten Bronze Ba(3-x)YbxTa5O15](https://arxiv.org/abs/2512.17234)
...
### [31] [Interplay of Defects and the Charge Density Wave State in Hf-Doped ZrTe$_{3}$](https://arxiv.org/abs/2512.17867)
...
### [32] [Machine Learning Assisted Parameter Tuning on Wavelet Transform Amorphous Radial Distribution Function](https://arxiv.org/abs/2512.17245)
...
### [33] [Vector Spin Chirality Switching in Noncollinear Antiferromagnets](https://arxiv.org/abs/2512.17248)
...
### [34] [Deep Learning Enabled Nanoscale X-ray Photoemission Electron Microscopy (nanoXPEEM)](https://arxiv.org/abs/2512.17252)
...
### [35] [In-operando dipole orientation for bipolar injection from air-stable electrodes into organic semiconductors](https://arxiv.org/abs/2512.17287)
...
### [36] [Spinless electric toroidal multipoles in ferroaxial ${\rm K_2Zr(PO_4)_2}$ revealed by symmetry-adapted closest Wannier analysis](https://arxiv.org/abs/2512.17290)
...
### [37] [Switchable Giant Spin Injection Current in Janus Altermagnet Fe$_2$SSeO](https://arxiv.org/abs/2512.17315)
...
### [38] [Influence of Pt/Ru ratios on the oxidation mechanism of MCrAlYTa coatings modified with Ptsingle bondRu overlays](https://arxiv.org/abs/2512.17384)
...
### [39] [Comparative analysis of electrodeposited Pt, Ru and Pt-Ru overlays for high-temperature oxidation protection](https://arxiv.org/abs/2512.17392)
*Majid Hosseinzadeh,Erfan Salahinejad*
...
### [40] [Eliminating the irregular surface layer of anodically-grown Ni-Ti-O nanopore arrays in a two-stage anodization](https://arxiv.org/abs/2512.17397)
...
### [41] [Magnetic, Structural, and Electronic Properties of CrOCl with the PBE Functional](https://arxiv.org/abs/2512.17405)
...
### [42] [Design principles for metal-organic receptors targeting optical recognition of Pd(II) in environmental matrices](https://arxiv.org/abs/2512.17719)
...
### [43] [Bandgap Engineering for Efficient Perovskite Solar Cells Under Multiple Color Temperature Indoor Lighting](https://arxiv.org/abs/2512.17479)
...
### [44] [Structure and Magnetic Properties of Vacuum-Annealed CoFeB Thin Films: From Amorphous Alloy to Metastable (Co,Fe)23B6 tau-Boride](https://arxiv.org/abs/2512.17501)
...
### [45] [Experimental evidence of dominant ultrafast diffusive energy transport by hot electrons in Cu](https://arxiv.org/abs/2512.17565)
...
### [46] [Multipoles as quantitative order parameters for altermagnetic spin splitting](https://arxiv.org/abs/2512.17587)
...
### [47] [Thermal Control of Size Distribution and Optical Properties in Gallium Nanoparticles](https://arxiv.org/abs/2512.17658)
...
### [48] [Single Ion Anisotropy of $Ln^{3+}$ (Ln = Tb, Dy, Ho) Controls Magnetic Excitations in $LnMn_{6}Sn_{6}$ Ferrimagnetic Kagome Metals](https://arxiv.org/abs/2512.17715)
...
### [49] [Corrosion-resistant and conductive Ti-Nb-O coatings tailored for ultra-low Pt-loaded BPPs and PTLs in PEM electrolyzers](https://arxiv.org/abs/2512.17721)
...
### [50] [Mechanistic Origin of Charge Separation and Enhanced Photocatalytic Activity in D-$π$-A-Functionalized UiO-66-NH$_2$ MOFs](https://arxiv.org/abs/2512.17778)
...
### [51] [Bayesian Methods for the Investigation of Temperature-Dependence in Conductivity](https://arxiv.org/abs/2512.17792)
...
### [52] [InfinityEBSD : Metrics-Guided Infinite-Size EBSD Map Generation With Diffusion Models](https://arxiv.org/abs/2512.17859)
...
### [53] [Experimentally Mapping the Phase Diagrams of Photoexcited Small Polarons](https://arxiv.org/abs/2512.17869)
